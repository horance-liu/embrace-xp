...
\newtcolorbox[auto counter,number within=section]{diff}[1]{left=0mm,right=0mm,oversize,enhanced jigsaw,breakable,pad at break*=1mm,colback=red!5!white,colframe=red!75!black,fonttitle=\bfseries, colbacktitle=red!85!black,enhanced, attach boxed title to top left={yshift=-2mm}, watermark color=white,title=\lstlistingname\thetcbcounter\ \code{#1},sidebyside,align=top,sidebyside align=top,sidebyside gap=3mm}
