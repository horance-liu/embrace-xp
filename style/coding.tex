...
\newcommand{\bt@HL@box}[2][]{%
  \tikz[#1]{%
    ...
    \node[anchor=base west, fill=green!30,outer sep=0pt,inner xsep=0pt, inner ysep=0pt, rounded corners=1pt, minimum height=\ht\strutbox+1pt,#1]{\raisebox{1pt}{\strut}\strut\usebox{#2}};
  }%
}
\makeatother
